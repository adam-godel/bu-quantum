...
requires: shors-algorithm
summary: 'Using quantum mechanics to share a key that cannot be intercepted unnoticed.'
---
<KatexSpan>
## Table of Contents
...
<a name="foot2">2</a>. For a description of an encryption scheme that is believed to be resistant to Shor's algorithm, see [Post-Quantum Cryptography, Kyber](/crash-course/post-quantum-cryptography).
