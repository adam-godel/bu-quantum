---
title: 'Bernstein-Vazirani Algorithm, Intro to Classiq'
requires: deutsch-jozsa-and-simons-algorithms
summary: 'Another oracular algorithm, and a higher-level way to describe quantum circuits.'
---
<KatexSpan>
...
$$`}
Therefore, since the amplitude of $|a\rangle$ is $1$, the quantum state after applying the algorithm will be the secret string $a$ with certainty.
...
Just as a side note, all of the code that I will be using on this page comes from [this documentation page](https://docs.classiq.io/latest/explore/algorithms/bernstein_vazirani/bernstein_vazirani) on Classiq.
