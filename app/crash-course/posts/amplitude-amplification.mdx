---
title: 'Rotation Matrices, Amplitude Amplification'
requires: grovers-algorithm
summary: 'The geometry underneath Grover's algorithm, generalized.'
---
<KatexSpan>
...
However, I feel like it's still important to talk about these calculations, since there are some interesting insights that can be gleaned from going through it. So on this page, we will come to the conclusions that we found visually, but through numerical calculations.
