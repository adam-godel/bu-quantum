...
summary: 'The vectors, matrices, and inner products that quantum computing is built on.'
---
<KatexSpan>
## Table of Contents
...
There are a few different ways to write the inner product. In quantum computing, we generally use <a href="https://en.wikipedia.org/wiki/Bra%E2%80%93ket_notation" target="_blank">bra-ket notation</a>, where we would write this operation as $\langle a | b \rangle$. For more on bra-ket notation, see [Bra-Ket Notation](/crash-course/bra-ket-notation).
...
Throughout these pages, you will see expressions normalized to satisfy this rule. An example is $|+\rangle$ where: 
{String.raw`$$
