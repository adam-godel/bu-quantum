        ...
        <div className="lg:min-h-[calc(100vh-288px)] mb-8 flex flex-col justify-center">
            ...
            >
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 justify-center">
                    <MemberProfile name="Yebin Song" role="Director" imageUrl="/adam.png" linkedin="https://www.linkedin.com/in/adam-godel" bio={<>Passionate about quantum computing.<br/>QSL fellow @ Wiser/NNL.<br/>Awards @ iQuHack & QRISE.<br/>Not fault-tolerant myself.</>}/>
                    <MemberProfile name="Adam Godel" role="Founder" imageUrl="/nico.png" linkedin="https://www.linkedin.com/in/adam-godel" bio={<>Passionate about quantum computing.<br/>QSL fellow @ Wiser/NNL.<br/>Awards @ iQuHack & QRISE.<br/>Not fault-tolerant myself.</>}/>
                    <MemberProfile name="Allen Chen" role="???" imageUrl="/travis.png" linkedin="https://www.linkedin.com/in/travis-meyer-2b313a299" bio={<>passionate about something.<br/>swe & excel victim.<br/>5’8.</>}/>
                    <MemberProfile name="Artem Arefev" role="Head of Physics" imageUrl="/travis.png" linkedin="https://www.linkedin.com/in/travis-meyer-2b313a299" bio={<>passionate about something.<br/>swe & excel victim.<br/>5’8.</>}/>
                </div>
            </div>
        </div>
    )
