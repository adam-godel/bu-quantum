        ...
        <div className="lg:min-h-[calc(100vh-288px)] mb-8 flex flex-col justify-center">
            ...
            >
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 justify-center">
                    ...
                    <MemberProfile name="nico jackson" role="vice director" imageUrl="/nico.png" linkedin="https://www.linkedin.com/in/nicola-jackson-64b22833b" bio={<></>}/>
                    ...
                    <div className="flex-col md:flex-row md:col-span-3 flex justify-center gap-8">
                        <MemberProfile name="jacky lin" role="head of operations" imageUrl="/jacky.png" linkedin="https://www.linkedin.com/in/lin-jacky" bio={<></>}/>
                        <MemberProfile name="timothy wright" role="head of pedagogy" imageUrl="/timothy.png" linkedin="https://www.linkedin.com/in/timmyjr11" bio={<></>}/>
                    </div>
                </div>
            </div>
        </div>
