---
title: 'Iterative Quantum Phase Estimation'
requires: quantum-fourier-transform
summary: 'Phase estimation rewritten to use far fewer qubits.'
---
<KatexSpan>
On this page, I want to cover a variation of the quantum phase estimation algorithm, known as **iterative quantum phase estimation** (IQPE), as well as talk a bit about Hamiltonian simulation.
