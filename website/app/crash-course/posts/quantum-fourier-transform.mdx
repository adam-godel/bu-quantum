...
requires: grovers-algorithm
summary: 'The transform and the estimation routine that most advanced algorithms are built from.'
---
<KatexSpan>
## Table of Contents
...
This page is pretty involved, as we're going to set up most of the groundwork necessary to understand Shor's algorithm, arguably the most important quantum algorithm known to date.
...
Firstly, I want to note how remarkable it is that this algorithm can find eigenvalues without diagonalizing a matrix. This can allow for much more efficient calculations, especially for large matrices. If you weren't convinced before, this is a clear example of the utility of quantum computing. However, quantum hardware isn't quite there yet to compute cases that would be out of reach for classical computers. As time passes and quantum hardware becomes better, though, this will almost certainly change.
