---
title: 'CHSH Game'
requires: superdense-coding-and-teleportation
summary: 'A game that quantum strategies win more often than any classical strategy can.'
---
<KatexSpan>
I want to use this page to discuss the CHSH game, which is another cool example of quantum pseudo-telepathy but one that's a little less strong than the GHZ game since victory is not guaranteed.
