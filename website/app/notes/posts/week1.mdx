...
<Quiz 
    ...
    answers={[String.raw`$|+\rangle = \frac{1}{\sqrt{2}}|0\rangle-\frac{1}{\sqrt{2}}|1\rangle$`, String.raw`$|i+\rangle = \frac{i}{\sqrt{2}}|0\rangle+\frac{i}{\sqrt{2}}|1\rangle$`, String.raw`$|1\rangle = \frac{1}{\sqrt{2}}|+\rangle-\frac{1}{\sqrt{2}}|-\rangle$`, String.raw`$|-\rangle = \frac{1}{\sqrt{2}}|0\rangle-\frac{1}{\sqrt{2}}|+\rangle$`]}
    correct={2}
    explanation={[<span>This is <InlineMath>|-\rangle</InlineMath> by definition.</span>, <span>Remember that <InlineMath>\alpha</InlineMath> should be a real number. Both of the coefficients shouldn't be imaginary.</span>, <span>Subtracting the <InlineMath>|-\rangle</InlineMath> term cancels out the <InlineMath>|0\rangle</InlineMath> term, leaving only the <InlineMath>|1\rangle</InlineMath>.</span>, <span>This cancels out the <InlineMath>|0\rangle</InlineMath> term, so it can't be <InlineMath>|+\rangle</InlineMath>.</span>]}
/>
