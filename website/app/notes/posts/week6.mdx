...
<a name="foot2">2</a>. I feel like this is much easier to "see" and understand visually than it is to compute. If you're interested in computing this rotation rigorously and a discussion of the generalization of Grover's algorithm, known as **amplitude amplification**, see the [addendum](/notes/week6-addendum).
</KatexSpan>