...
Here, the $\dag$ symbol denotes the **conjugate transpose** of the vector. You may be familiar with the [transpose](https://en.wikipedia.org/wiki/Transpose) of a matrix already; the conjugate transpose simply also flips the sign of the imaginary part of each element. For example,
{String.raw`$$
