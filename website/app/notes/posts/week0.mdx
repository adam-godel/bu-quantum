...
Lastly, other than some one-off articles or papers I mention in the lessons or addendums themselves, I rely on my own research and experience in designing the content. In terms of my background, I worked on the [glued trees algorithm](https://github.com/adam-godel/glued-trees) for Classiq and I am currently a WISER Quantum Solutions Launchpad Fellow working with the US Naval Nuclear Lab.
